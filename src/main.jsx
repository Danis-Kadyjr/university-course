...
const learningSlides = [
  {
    ...
    text: "Получаете знания в оффлайн формате в малых группах с возможностью задавать интересующие вас вопросы преподавателю.",
  },
  {
    title: "Практика",
    subtitle: "Выполнение заданий",
    text: "Мы убеждены, что навыки закрепляются только на практике. Поэтому после каждой теоретической части вас ждёт практическое задание или тест. Все задачи максимально приближены к реальным — их результат вы сможете с гордостью добавить в своё портфолио.",
  },
  {
    title: "Анализ результатов",
    subtitle: "Контроль со стороны преподавателя",
    text: "Ваши задания проверяет преподователь. Если что-то не получается — он подскажет решение и поможет сделать ваш проект ещё круче.",
  },
];
    ...
    <main>
      ...
      <section className="hero panel" id="top">
        <div className="heroText">
          <div className="mainBlock">
            ...
            <p>
              Наш курс по 3D-визуализации — это ваш ключ к освоению профессии
              3D-визуализатора!
            </p>
          </div>
      ...
      <section className="section teacher" id="teacher">
        ...
        <div className="teacherGrid">
          ...
          <article className="teacherInfo">
            <h3>Данис Кадиров</h3>
            <strong>3D-визуализатор, дизайнер</strong>
            <p>
      ...
      <section className="section signup" id="signup">
        <article className="priceCard">
          ...
          <div className="price">
            <span>
              40 000₽/<s>44 0000₽</s> при единовременной оплате
            </span>
          </div>
        </article>
